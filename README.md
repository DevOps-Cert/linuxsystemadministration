...
### Squid
One of the things we are practicing anyways is setting up a squid caching server.  So, this might be the ideal approach to make updates apply faster locally off your LAN and can be up and running quickly (apt-mirror requires you to download the entire mirror which can take a long time).  Set Debian package files to a longer life than normal (perhaps several months).  
```
...
* Blah
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzEwMjg1MDhdfQ==
-->